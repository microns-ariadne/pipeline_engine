function mergeH5(npPath,subdirectory,ylen,xlen,depth,video,empath)
...
parfor (blocki=1:NBlocks,36)
    ...
    h5Segmentation = fullfile(folderPath,'segmentation_union_subblocks.h5');
