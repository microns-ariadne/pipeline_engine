...
void agglomerate_stack_parallel(Stack& stack, int num_top_edges, bool rand_prior, double threshold, bool use_mito, bool use_edge_weight = false, bool synapse_mode=false);
