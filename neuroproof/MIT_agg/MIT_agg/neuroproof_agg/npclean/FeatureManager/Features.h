...
class FeatureCompute {
  public:
    ...
    virtual void add_point_batch(std::vector<double>& val, void * cache, unsigned int x = 0, unsigned int y = 0, unsigned int z = 0) = 0;
    ...
    virtual void merge_cache(void * cache1, void * cache2, bool del_cache2 = true) = 0; 
...
class FeatureHist : public FeatureCompute {
  public:
    ...
    void add_point_batch(std::vector<double>& val, void * cache, unsigned int x = 0, unsigned int y = 0, unsigned int z = 0);
    ...
    void merge_cache(void * cache1, void * cache2, bool del_cache2 = true);
    void print_name();	
...
class FeatureInclusiveness : public FeatureCompute {
  public:
    ...
    void merge_cache(void * cache1, void * cache2, bool del_cache2)
    {
        return;
    }
