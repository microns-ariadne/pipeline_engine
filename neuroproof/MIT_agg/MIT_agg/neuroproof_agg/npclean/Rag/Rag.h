...
class Rag {
  public:
    ...
    */
    ...
    //typedef google::dense_hash_set<RagEdge<Region>*, RagEdgePtrHash<Region>, RagEdgePtrEq<Region> >  EdgeHash;
    ...
    //typedef google::dense_hash_set<RagNode<Region>*, RagNodePtrHash<Region>, RagNodePtrEq<Region> >  NodeHash;
...
{
/*
    RagNode<Region>* null_node = RagNode<Region>::New(Region());
    RagNode<Region>* null_node2 = RagNode<Region>::New(Region());
    RagEdge<Region>* null_edge = RagEdge<Region>::New(null_node, null_node2);

    RagNode<Region>* null2_node = RagNode<Region>::New(Region());
    null2_node->set_node_id(-1);
    RagNode<Region>* null2_node2 = RagNode<Region>::New(Region());
    RagEdge<Region>* null2_edge = RagEdge<Region>::New(null2_node, null2_node2);

    rag_edges.set_empty_key(null_edge);
    rag_edges.set_deleted_key(null2_edge);
    rag_nodes.set_empty_key(null_node);
    rag_nodes.set_deleted_key(null2_node);
*/
